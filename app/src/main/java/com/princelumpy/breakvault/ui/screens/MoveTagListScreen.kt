...
import com.princelumpy.breakvault.viewmodel.MoveTagListViewModel
...
fun TagListItem(
    ...
    Card(
        ...
        Row(
            modifier = Modifier
                .fillMaxWidth()
                .padding(horizontal = AppStyleDefaults.SpacingLarge, vertical = AppStyleDefaults.SpacingMedium),
...
fun MoveTagListScreenPreview() {
    ComboGeneratorTheme {
        MoveTagListScreen(navController = rememberNavController(), moveTagListViewModel = viewModel())
    }
}
