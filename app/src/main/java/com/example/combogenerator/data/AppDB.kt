...
abstract class AppDB : RoomDatabase() {
    ...
    companion object {
        ...
        // Migration from version 1 to version 2 (kept for historical purposes if ever needed)
        ...
        fun getDatabase(context: Context): AppDB {
            ...
            return INSTANCE ?: synchronized(this) {
                INSTANCE ?: Room.databaseBuilder(
                    ...
                    .addMigrations(MIGRATION_1_2) // Existing migration
        ...
        suspend fun prepopulateDefaultTags(database: AppDB) {
            ...
            Log.d("AppDB", "Pre-populated default tags (if any were missing): $PREPOPULATE_TAGS")
        }
    }
