...
**Goal:** A companion app for Breakdancers (B-Boys/B-Girls) to manage moves, generate combos, and
track battle readiness.

## Architectural Pattern

- **MVVM (Model-View-ViewModel):**
    - **Model:** Room Database Entities & DAOs (`com.princelumpy.breakvault.data`).
    - **ViewModel:** `AndroidViewModel` subclasses holding LiveData/State (
      `com.princelumpy.breakvault.viewmodel`).
...
1. **Practice Mode:**
    ...
    - Generate random or structured combos based on moveTags.
    - "Flashcard" mode.
2. **Battle Mode:**
